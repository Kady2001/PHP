...
$id_edit =$_GET['id'];
$sql_up =" SELECT * from hoa_don_ban where id_hdb =$id_edit";
...
if(isset($_POST['sbm'])) {
		...
		//Luu vao database
			...
			$sql_edit = "UPDATE `hoa_don_ban` SET `id_nv`='$nv',`id_kh`='$khachhang',`date_order`='$ngaylendon',`tong_tien`='$tongtien',`payment`='$hinhthucthanhtoan',`status`='$trangthai',`note_hdb`='$note',`UPDATED_AT`='$updated_at' WHERE id_hdb=$id_edit";
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Sửa thông tin hóa đơn bán</h2>
			</div>
			<div class="panel-body">
            <div class="form-group">
            <form method="POST">  
				<div class="form-group">
				  <label for="mancc">Mã hóa đơn bán: <?php echo $id_edit ?></label>
			    ...
			    <input class="date form-control" type="text" value="<?php echo $row_up['date_order']; ?>" name="ngaylendon">
				</div>
                
				<div class="form-group">
				  <label for="chitiet">Tổng tiền:</label>
				  <input required="true" type="text" class="form-control" value="<?php echo $row_up['tong_tien']; ?>" id="chitiet" name="tongtien">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <input required="true" type="text" class="form-control" value="<?php echo $row_up['note']; ?>" id="chitiet" name="note">
				</div>
