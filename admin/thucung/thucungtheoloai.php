...
$id_loaithucung =$_GET['id_loaithucung'];
$sql ="SELECT * FROM thucung INNER join loaithucung  on thucung.id_loaithucung= loaithucung.id_loaithucung JOIN nha_cung_cap on thucung.id_ncc = nha_cung_cap.id_ncc WHERE thucung.id_loaithucung =$id_loaithucung";
